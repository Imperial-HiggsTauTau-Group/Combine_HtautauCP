...
#   obs_significance = np.sign(main_scan['func'].Eval(90.)-main_scan['func'].Eval(0.))*math.sqrt(scipy.stats.chi2.ppf(scipy.stats.chi2.cdf(abs(main_scan['func'].Eval(90.)-main_scan['func'].Eval(0.)),1),1))
...
if not args.no_title: plot.DrawTitle(pads[0], '220 fb^{-1} (13.6 TeV)', 3)
pads[0].SetTicks(1)
